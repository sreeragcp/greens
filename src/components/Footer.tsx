    ...
    <footer className="border-t border-border/60 py-12 sm:py-16 bg-gradient-section">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary/20 glow-brand-sm">
                <GraduationCap size={18} className="text-primary" />
              </div>
              <span className="text-lg font-bold gradient-text">Greens</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-muted-foreground">
              ...
              <li><a href="mailto:contact@greens.in" className="hover:text-primary transition-colors">About Us</a></li>
              <li><a href="mailto:contact@greens.in" className="hover:text-primary transition-colors">Privacy Policy</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-muted-foreground">
              <li className="flex items-center gap-2"><Mail size={14} className="text-primary" /> contact@greens.in</li>
        ...
        <div className="mt-12 pt-8 border-t border-border/60 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} Greens. All rights reserved.</p>
